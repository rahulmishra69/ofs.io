    ...
    <div class="main-wrapper">
        ...
        <div class="site-content-wrapper">
            ...
            <div style="margin-top:2rem; margin-left:18rem; ">
                ...
                <h2 style="margin-top:2rem; position:relative; right:2rem;">Thankyou For You Buy Plan Have a Nice Day</h2>
              <div style="margin-top:2rem;">
              <button class="btn btn-primary" style="margin-right:2rem;" onclick="window.location.href='sub.php';" >View Order</button>
