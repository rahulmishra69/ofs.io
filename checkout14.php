<?php
    ...
    if(isset($_REQUEST['submit']))
    {
        ...
        else 
        {
            ...
            $sql = "INSERT INTO rahul (food,price,username,number,address,state,city,mode)VALUES('Donuts','99','$name','$number','$address','$state','$city','$mode')";
    ...
    <div class="main-wrapper">
        ...
        <div class="container">
            <div class="form-control">
                <img style="width:200px; margin-top:20%; margin-bottom:1rem; " src="./images/donut.jpg">
                <h3 py-4 style=" position:relative; margin-left:2rem;" >Donuts</h3>
            <p style="margin-left:2%; margin-top:1.5%; margin-bottom:0.7rem;margin-left:4rem;"><s>&#8377; 109</s></p>
            <h5 style="color: red; margin-left:1.5%;margin-left:4rem;">&#8377; 99 only</h5>
            <button onclick="window.location.href='new13.php';" style="margin-top: 1rem;" class="btn btn-secondary">Cancel Order</button>
