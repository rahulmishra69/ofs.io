<?php
    ...
    if(isset($_REQUEST['submit']))
    {
        ...
        else 
        {
            ...
            $sql = "INSERT INTO rahul (food,price,username,number,address,state,city,mode)VALUES('Chicken Fry','189','$name','$number','$address','$state','$city','$mode')";
...
<body>
    <div class="main-wrapper">
        ...
        <div class="container">
            <div class="form-control">
                <img style="width:200px; margin-top:20%; margin-bottom:1rem; " src="./images/chicken.png">
                <h3 py-4 style=" position:relative; margin-left:2rem;" >Chicken Fry</h3>
            <p style="margin-left:2%; margin-top:1.5%; margin-bottom:0.7rem;margin-left:4rem;"><s>&#8377; 209</s></p>
            <h5 style="color: red; margin-left:1.5%;margin-left:4rem;">&#8377; 189 only</h5>
            <button onclick="window.location.href='new11.php';" style="margin-top: 1rem;" class="btn btn-secondary">Cancel Order</button>
   ...
   <div style="margin-top: -34rem;" class="center">
    ...
    <form action="" method="post">
        ...
        <input type="radio" name="mode" onclick="window.location.href='https://rzp.io/i/0sxKMj3Os';" style="width: 20px; cursor:pointer;" value="upi">Upi
