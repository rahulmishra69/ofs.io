<?php
    ...
    if(isset($_REQUEST['submit']))
    {
        ...
        else 
        {
            ...
            $sql = "INSERT INTO rahul (food,price,username,number,address,state,city,mode)VALUES('Summer Salad','299','$name','$number','$address','$state','$city','$mode') ";
...
<body style="overflow-y:scroll; ">
    <div class="main-wrapper">
        ...
        <div class="container">
            <div class="form-control">
                <img style="width:200px; margin-top:20%; margin-bottom:1rem; " src="./images/plate-1.png">
                <h3 py-4>Summer Salad</h3>
            <p style="margin-left:2%; margin-top:1.5%; margin-bottom:0.7rem;"><s>&#8377; 349</s></p>
            <h5 style="color: red; margin-left:1.5%;">&#8377; 299 only</h5>
            <button onclick="window.location.href='new1.php';" style="margin-top: 1rem;" class="btn btn-secondary">Cancel Order</button>
   ...
   <div style="margin-top: -34rem;" class="center">
    <div style="width: 107%;" class="header">Please Fill The Details</div>
    <form action="" method="post">
        ...
        <input type="radio" name="mode" onclick="window.location.href='https://rzp.io/i/EidSK4L';" style="width: 20px;" class="btn btn-primary"  value="upi">Upi
