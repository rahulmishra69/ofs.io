    ...
    <section class="product container my-5"> 
       <div class="row mt-5 flex">
        <div class="col-lg-5 col-md-12 col-12 flex-1">
            <img class="imf-fluid w-60" src="./images/chicken.png">
        </div>
        <div class="col-lg-5 col-md-12 col-12 flex-1">
            <h6>For you</h6>
            <h3 py-4>Chicken Fry</h3>
            <p><s>&#8377; 209</s></p>
            <h5 style="color: red;">&#8377; 189 only</h5>
           
           <button onclick="window.location.href='checkout12.php';" class="btn btn-secondary">Buy now</button>
