<?php
    ...
    if(isset($_REQUEST['submit']))
    {
        ...
        else 
        {
            ...
            $sql = "INSERT INTO rahul (food,price,username,number,address,state,city,mode)VALUES('Mutter paneer','99','$name','$number','$address','$state','$city','$mode')";
    ...
    <div class="main-wrapper">
        ...
        <div class="container">
            <div class="form-control">
                <img style="width:200px; margin-top:20%; margin-bottom:1rem; " src="./images/mu.png">
                <h3 py-4 style=" position:relative; margin-left:2rem;" >Mutter paneer</h3>
            <p style="margin-left:2%; margin-top:1.5%; margin-bottom:0.7rem;margin-left:4rem;"><s>&#8377; 149</s></p>
            <h5 style="color: red; margin-left:1.5%;margin-left:4rem;">&#8377; 99 only</h5>
            <button onclick="window.location.href='new14.php';" style="margin-top: 1rem;" class="btn btn-secondary">Cancel Order</button>

            </div>

         </div>

   <div style="margin-top: -33rem;" class="center">
    ...
    <form action="" method="post">
        ...
        <input type="radio" name="mode" style="width: 20px; cursor:pointer;" onclick="window.location.href='https://rzp.io/i/icVLzCdv';" value="upi">Upi
