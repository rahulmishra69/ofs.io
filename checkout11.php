<?php
    ...
    if(isset($_REQUEST['submit']))
    {
        ...
        else 
        {
            ...
            $sql = "INSERT INTO rahul (food,price,username,number,address,state,city,mode)VALUES('Coffee','150','$name','$number','$address','$state','$city','$mode')";
...
<body>
    <div class="main-wrapper">
        ...
        ?>
                <img style="margin-top:15rem;width:200px;" src="<?php echo "../admin/media/added-product/".$list['image'];?>">
                <h3 style="margin-left:5rem;" py-4><?php echo $list['name']; ?></h3>
                <p style="margin-left:5rem;"><s>&#8377; <?php echo $list['mrp'] ?></s></p>
            <h4 style="color: red;margin-left:5rem;">&#8377; <?php echo $list['price'];?></h4>
            <button onclick="window.location.href='added-ptoduct-food.php';" style="margin-top: 1rem;" class="btn btn-secondary">Cancel Order</button>

            </div>

         </div>

   <div style=" margin-top: -34rem;" class="center">
    ...
    <form action="" method="post">
        ...
        <input type="radio" name="mode" style="width: 20px; cursor:pointer;"  onclick="window.location.href='https://rzp.io/i/uQL0dwkoz';" value="upi">Upi
        <div style="color: red; margin: top 2.5rem; padding:1rem;"> <?php echo $message ?></div>
        <input type="submit" name="submit" style="font-size: 13px;margin-top:-1rem;" onclick="msg_click" value="Proceed To check">
