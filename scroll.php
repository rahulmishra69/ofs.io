...
<body>
    ...
    <div class="main-wrapper magic-hover">
        ...
        <div class="site-content-wrapper">
            ...
            <div class="site-content">
                ...
                <div style="margin-bottom: 0.5rem;" class="navbar magic-hover">
                      ...
                      <div class="slides-container">
                          <div class="slide active">
                              <div class="content">
                                  ...
                                  <h3>Upto 50% off</h3>
                                  <a href="#" class="btn"onclick="window.location.href='scroll-product.php';">Shop now</a>
                              </div>
                              <div class="image">
                                  <img src="./images/rasberry.png">
                              </div>
                          </div>
                          ...
                          <div class="slide">
                              <div class="content">
                                  <span>Fresh and organic</span>
                                  <h3>Upto 50% off</h3>
                                  <a href="scroll-product2.php" class="btn" >Shop now</a>
                              </div>
                              <div class="image">
                                  <img style="width: 78%;" src="./images/vegies.png">
                              </div>
                          </div>
              
                          <div class="slide">
                              <div style="margin-right: 4rem;" class="content">
                                  <span>Fresh and organic</span>
                                  <h3>Upto 50% off</h3>
                                  <a href="scroll-product3.php" class="btn">Shop now</a>
                              </div>
                              <div class="image">
                                  <img style="width: 69%;"  src="./images/cupcake.png">
                              </div>
                          </div>
        ...
        <div class="container">
           ...
           <div class="btn-1 text-center">
            <button onclick="window.location.href='food-btn.php';" class="btn btn-secondary">View more</button>
           </div>
