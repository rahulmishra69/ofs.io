...
<body>
         ...
         <div class="mobile-nav">
            <div class="cart">
                <div class="flex item-center">
                    ...
                    <div onclick="window.location.href='user-login.php';"><a href="user-login.php">Log in</a></div>
                </div>
            </div>
            ...
            <div class="nav-top">
                <ul>
                    ...
                    <li>
                        <a onclick="window.location.href='services.php';">services</a>
                    </li>
                    <li>
    ...
    <header class="topbar">
        <div class="container flex justify-between item-center">
            ...
            <div>
            <img style="cursor: pointer;" src="./icons/user-icon.svg">
            <a href="user-login.php">Log in</a>
                               
            </div> 
            <span class="divider">|</span>
            <div>
            <img style="cursor: pointer;" src="./icons/edit.svg">
            <a href="user-sign.php">Sign up</a>
    ...
    <header class="top">
        <div class="container flex justify-between item-center">
            <div class="phone flex">
                <img src="./icons/phone.svg">
                <div>
                    <h5 style="font-size: 0.8rem;">Call US: (+84) 123 456 789</h5>
                    <h6>E mail:rahulmishra3865@gmail.com</h6>
                </div>
            </div>
            <div class="logo">
            ...
            <div class="clock flex">
                <img src="./icons/clock.svg">
                <div>
                    <h5  style="font-size: 0.8rem;">Working Hours:</h5>
                    <h6>Mon - Sat (8.00am - 12.00am)</h6>
                </div>
            </div>
        </div>
        ...
        <div class="navbar magic-hover">
            <div class="container flex justify-center">
                <a onclick="window.location.href='index.php';" href="indexx.php">Home</a>
                <a onclick="window.location.href='offer.php';" href="#sail">Offer</a>
                <a onclick="window.location.href='subscribe.php';" href="#subscribe">Subscribe</a>
                <a onclick="window.location.href='products.php';" href="#rahul1">Products</a>
                <a onclick="window.location.href='services.php';" href="#rahul4">Services</a>
                <a onclick="window.location.href='newses.php';" href="#News">News</a>
                <a onclick="window.location.href='conntact.php';" href="#contact">Contact</a>
            </div>
    ...
    foreach($get_product as $list)
     {
      ...
      ?>
       <div class="row mt-5 flex">
        ...
        <img src="<?php echo "../admin/media/added-product/".$list['image'];?>">
        </div>
        <div class="col-lg-5 col-md-12 col-12 flex-1">
            <h6>For you</h6>
            <h3 py-4><?php echo $list['name']; ?></h3>
            <p><s>&#8377; <?php echo $list['mrp'] ?></s></p>
            <h4 style="color: red;">&#8377; <?php echo $list['price'];?></h4>
          
           <button class="btn btn-secondary" onclick="window.location.href='checkout11.php';" >Buy now</button>
           <h2 class="mt-4 mb-5">Food Details</h2>
           <span>
        ...
        <div class="container">
            ...
            <div class="slider">
                ...
                <div class="food-slider">
                    ...
                    <div onclick="window.location.href='new9.php';" class="food-card">
                        <div class="product-image flex justify-center">
