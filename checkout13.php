<?php
    ...
    if(isset($_REQUEST['submit']))
    {
        ...
        else 
        {
            ...
            $sql = "INSERT INTO rahul (food,price,username,number,address,state,city,mode)VALUES('cupcake','69','$name','$number','$address','$state','$city','$mode')";
    ...
    <div class="main-wrapper">
        ...
        <div class="container">
            <div class="form-control">
                <img style="width:200px; margin-top:20%; margin-bottom:1rem; " src="./images/cupcake.png">
                <h3 py-4 style=" position:relative; margin-left:2rem;" >cupcake</h3>
            <p style="margin-left:2%; margin-top:1.5%; margin-bottom:0.7rem;margin-left:4rem;"><s>&#8377; 89</s></p>
            <h5 style="color: red; margin-left:1.5%;margin-left:4rem;">&#8377; 69 only</h5>
            <button onclick="window.location.href='new12.php';" style="margin-top: 1rem;" class="btn btn-secondary">Cancel Order</button>

            </div>

         </div>

   <div style="margin-top: -39rem;" class="center">
    ...
    <form action="" method="post">
        ...
        <input type="radio" name="mode" style="width: 20px; cursor:pointer;" onclick="window.location.href='https://rzp.io/i/xpwJ6Tr';" value="upi">Upi
