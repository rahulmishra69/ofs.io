<?php
    ...
    if(isset($_REQUEST['submit']))
    {
        ...
        else 
        {
            ...
            $sql = "INSERT INTO rahul (food,price,username,number,address,state,city,mode)VALUES('vegies','199','$name','$number','$address','$state','$city','$mode')";
...
<body>
    <div class="main-wrapper">
        ...
        <div class="container">
            <div class="form-control">
                <img style="width:200px; margin-top:20%; margin-bottom:1rem; " src="./images/vegies.png">
                <h3 py-4>vegies</h3>
            <p style="margin-left:2%; margin-top:1.5%; margin-bottom:0.7rem;"><s>&#8377; 298</s></p>
            <h5 style="color: red; margin-left:1.5%;">&#8377; 199 only</h5>
            <button onclick="window.location.href='scroll-product2.php';" style="margin-top: 1rem;" class="btn btn-secondary">Cancel Order</button>
   ...
   <div style="margin-top: -36rem;" class="center">
    ...
    <form action="" method="post">
        ...
        <input type="radio" name="mode" onclick="window.location.href='https://rzp.io/i/imMT1yE';" style="width: 20px;" class="btn btn-primary"  value="upi">Upi
