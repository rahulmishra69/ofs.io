  ...
  if(isset($_POST['submit']))
  {
    ...
    if(isset($_REQUEST['submit']))
    {
      ...
      else 
      {
        ...
        $mode = $_REQUEST['mode'];
        $sql = "INSERT INTO subscribe (name, email, state, city,address, mode, plan) VALUES('$name', '$email','$state','$city','$address','$mode','Basic plan') ";
...
<body style="overflow-y: scroll;">
   ...
   <div style="margin-top:2rem; height:1rem; " class="center">
    <div style="width: 107%;" class="header">Basic Plan</div>
    <form action="" method="post">
        ...
        <input type="radio" style="width:10px;cursor:pointer;" onclick="window.location.href='https://rzp.io/i/qRGRtSFFLD';" value="Upi" name="mode">Upi<br>

        <input type="submit" name="submit"style="margin-top:2.5rem;"   id="submit" value="submit"> 
