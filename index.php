         ...
         <div class="mobile-nav">
            <div class="cart">
                <div class="flex item-center">
                    ...
                    <div onclick="window.location.href='user-login.php';"><a href="#">Log in</a></div>
                </div>
            </div>
                ...
                <header style="background-color: #eebf00;" class="topbar">
                    <div class="container flex justify-between item-center">
                        ...
                        <div class="auth flex justify-between item-center">
                            <div>
                                <?php 
                                echo'<img src="./icons/user-icon.svg">';
                                echo'<a href="user-login.php">Log in</a>';
                                echo'<span class="divider">|</span>';
                                echo'<img src="./icons/edit.svg">';
                                echo'<a href="user-sign.php">Sign Up</a>';  
                    ...
                    <div class="container">
                        ...
                        <div class="slider">
                            ...
                            <div id="food-slider" class="food-slider">
                                ...
                                <div onclick="window.location.href='new1.php';" class="food-card magic-shadow">
