    ...
    <section class="product container my-5"> 
       <div class="row mt-5 flex">
        <div class="col-lg-5 col-md-12 col-12 flex-1">
            <img class="imf-fluid w-60" src="./images/plate-4.jpg">
        </div>
        <div class="col-lg-5 col-md-12 col-12 flex-1">
            <h6>For you</h6>
            <h3 py-4>Greek Salad</h3>
            <p><s>&#8377; 199</s></p>
            <h5 style="color: red;">&#8377; 149 only</h5>
           <button class="btn btn-secondary" onclick="window.location.href='checkout4.php';" >Buy now</button>
