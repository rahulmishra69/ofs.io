    ...
    <section class="product container my-5"> 
       <div class="row mt-5 flex">
        <div class="col-lg-5 col-md-12 col-12 flex-1">
            <img class="imf-fluid w-60" src="./images/plate-2.png">
        </div>
        <div class="col-lg-5 col-md-12 col-12 flex-1">
            <h6>For you</h6>
            <h3 py-4>Russian Salad</h3>
            <p><s>&#8377; 399</s></p>
            <h5 style="color: red;">&#8377; 299 only</h5>
           
           
           <button onclick="window.location.href='checkout2.php';" class="btn btn-secondary">Buy now</button>
