<?php
    ...
    if(isset($_REQUEST['submit']))
    {
        ...
        else 
        {
            ...
            $sql = "INSERT INTO rahul (food,price,username,number,address,state,city,mode)VALUES('Burger','99','$name','$number','$address','$state','$city','$mode')";
...
<body>
    <div class="main-wrapper">
        ...
        <div class="container">
            <div class="form-control">
                <img style="width:200px; margin-top:20%; margin-bottom:1rem; " src="./images/plate-5.jpg">
                <h3 py-4 style=" position:relative; margin-left:4rem;">Burger</h3>
            ...
            <button onclick="window.location.href='new5.php';" style="margin-top: 1rem;" class="btn btn-secondary">Cancel Order</button>
   ...
   <div style="margin-top: -33rem;" class="center">
    ...
    <form action="" method="post">
        ...
        <input type="radio" name="mode" style="width: 20px;cursor:pointer;" onclick="window.location.href='https://rzp.io/i/sCPjvUen';" value="upi">Upi
