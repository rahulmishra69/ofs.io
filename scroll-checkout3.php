<?php
    ...
    if(isset($_REQUEST['submit']))
    {
        ...
        else 
        {
            ...
            $sql = "INSERT INTO rahul (food,price,username,number,address,state,city,mode)VALUES('cupcake','165','$name','$number','$address','$state','$city','$mode')";
...
<body>
    <div class="main-wrapper">
        ...
        <div class="container">
            <div class="form-control">
                ...
                <h3 py-4>cupcake</h3>
            <p style="margin-left:2%; margin-top:1.5%; margin-bottom:0.7rem;"><s>&#8377; 250</s></p>
            <h5 style="color: red; margin-left:1.5%;">&#8377; 165 only</h5>
            <button onclick="window.location.href='scroll-product3.php';" style="margin-top: 1rem;" class="btn btn-secondary">Cancel Order</button>
   ...
   <div style="margin-top: -39rem;" class="center">
    ...
    <form action="" method="post">
        ...
        <input type="radio" name="mode" onclick="window.location.href='https://rzp.io/i/Fn6XTVPd';" style="width: 20px;" class="btn btn-primary"  value="upi">Upi
