  ...
  if(isset($_POST['submit']))
  {
    ...
    if(isset($_REQUEST['submit']))
    {
      ...
      else 
      {
        ...
        $mode = $_REQUEST['mode'];
        $sql = "INSERT INTO subscribe (name, email, state, city,address, mode, plan) VALUES('$name', '$email','$state','$city','$address','$mode','Standred plan')";
...
<body style="overflow-y: scroll;">
   ...
   <div style="margin-top:2rem; height:1rem; " class="center">
    <div style="width: 107%;" class="header">Standred Plan</div>
    <form action="" method="post">
        ...
        <input type="radio" style="width:10px; cursor:pointer;" value="Upi" onclick="window.location.href='https://rzp.io/i/DFSHfGJ88K';" name="mode">Upi<br>
