         ...
         <div class="mobile-nav">
            <div class="cart">
                <div class="flex item-center">
                    <img style="cursor: pointer;" onclick="window.location.href='myaccount.php';" src="./icons/cart-dark.svg">
    ...
    <section class="product container my-5"> 
       <div class="row mt-5 flex">
        <div class="col-lg-5 col-md-12 col-12 flex-1">
            <img class="imf-fluid w-60" src="./images/plate-7.jpg">
        </div>
        <div class="col-lg-5 col-md-12 col-12 flex-1">
            <h6>For you</h6>
            <h3 py-4>South indian Dish</h3>
            <p><s>&#8377; 299</s></p>
            <h5 style="color: red;">&#8377; 199 only</h5>
            
           <button onclick="window.location.href='checkout7.php';" class="btn btn-secondary">Buy now</button>
